...
<body>
    ...
    <div id="wrapper">
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Search Invoice</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Cari tagihan anda dengan memasukkan Kode_Booking dan ID_Paket
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form enctype="multipart/form-data" method="POST" action="/postSearch" role="form">
                                        {{ csrf_field() }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="text" name="id_paket">
