                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            Semua Slider yang telah dibuat
                        </div>
                        <!-- /.panel-heading -->
                        <a href="{{url('addSlider')}}" class="btn btn-primary">Tambah Slider</a>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="{{$isi->id}}/editSlider" class="btn btn-warning" style="width: 60px">Edit</a>

                                            <form method="POST" action="{{$isi->id}}/delSlider">
                                                {{csrf_field()}}
