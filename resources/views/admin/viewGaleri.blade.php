            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <a href="{{url('addGaleri')}}" class="btn btn-primary">Tambah Galeri</a>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            <a href="{{$isi->id}}/editGaleri" class="btn btn-warning" style="width: 60px">Edit</a>

                                            <form method="POST" action="{{$isi->id}}/delGaleri">
                                                {{csrf_field()}}
