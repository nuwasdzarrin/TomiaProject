...
<head>
    ...
    <title>Explore Tomia Timur - Admin</title>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="{{URL::to('/cbt')}}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                        </li>
                        <li>
                            <a href="{{URL::to('/sli')}}"><i class="glyphicon glyphicon-play-circle"></i> Slider</a>
                        </li>
                        <li>
                            <a href="{{URL::to('/art')}}"><i class="fa fa-edit fa-fw"></i></i> Artikel</a>
                        </li>
                        <li>
                            <a href="{{URL::to('/gal')}}"><i class="fa fa-image"></i> Galeri</a>
                        </li>
                        <li>
                            <a href="{{URL::to('/vdo')}}"><i class="fa fa-video-camera"></i> Video</a>
                        </li>
                        <li>
                            <a href="{{URL::to('/pkt')}}"><i class="fa fa-files-o fa-fw"></i> Paket</a>
                        </li>
                        <li>
                            <a href="{{URL::to('/ord')}}"><i class="glyphicon glyphicon-shopping-cart"></i> Order</a>
                        </li>
