            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <!-- /.panel-heading -->
                        <a href="{{url('addArt')}}" class="btn btn-primary">Tambah Artikel</a>
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        ...
                                        <td>
                                            @if ($isi->tampilkan==0)
                                            <a href="tampil/{{$isi->id}}" title="Menampilkan Artikel" class="btn btn-success btn-md">Tampilkan</a>
                                            @else
                                            <a href="sembunyi/{{$isi->id}}" title="Menyembunyikan Artikel" class="btn btn-default btn-md">Sembunyikan</a>
                                            @endif
                                        ...
                                        <span class="glyphicon glyphicon-eye-open"></span></button>
                                            ...
                                            <a href="{{$isi->id}}/editArt" title="Edit Artikel" class="btn btn-warning btn-md" style="margin-bottom: 8px; margin-top: 5px;"><i class="glyphicon glyphicon-edit"></i></a>
                                            <form method="POST" action="{{$isi->id}}/delArt">
                                                {{csrf_field()}}
