...
<html lang="en">
	<head>
		...
		<link rel="shortcut icon" href="{{ asset('assetsfront/images/favicon.ico') }}" />
		<link rel="stylesheet" href="{{ asset('assetsfront/booking/css/booking.css') }}">
		<link rel="stylesheet" href="{{ asset('assetsfront/css/camera.css') }}">
		<link rel="stylesheet" href="{{ asset('assetsfront/css/owl.carousel.css') }}">
		<link rel="stylesheet" href="{{ asset('assetsfront/css/style.css') }}">
		<script src="{{ asset('assetsfront/js/jquery.js') }}"></script>
		<script src="{{ asset('assetsfront/js/jquery-migrate-1.2.1.js') }}"></script>
		<script src="{{ asset('assetsfront/js/script.js') }}"></script>
		<script src="{{ asset('assetsfront/js/superfish.js') }}"></script>
		<script src="{{ asset('assetsfront/js/jquery.ui.totop.js') }}"></script>
		<script src="{{ asset('assetsfront/js/jquery.equalheights.js') }}"></script>
		<script src="{{ asset('assetsfront/js/jquery.mobilemenu.js') }}"></script>
		<script src="{{ asset('assetsfront/js/jquery.easing.1.3.js') }}"></script>
		<script src="{{ asset('assetsfront/js/owl.carousel.js') }}"></script>
		<script src="{{ asset('assetsfront/js/camera.js') }}"></script>
		<!--[if (gt IE 9)|!(IE)]><!-->
		<script src="{{ asset('assetsfront/js/jquery.mobile.customized.min.js') }}"></script>
		<!--<![endif]-->
		<script src="{{ asset('assetsfront/booking/js/booking.js') }}"></script>
		<script>
...
<!--==============================header=================================-->
		<header>
			<div class="container_12">
				...
				<div class="grid_12">
					<h1>
						<a href="index.html">
							<img src="{{ asset('assetsfront/images/logo.png') }}" alt="Your Happy Family">
						</a>
					</h1>
				</div>
			</div>
		...
		<div class="slider_wrapper">
			<div id="camera_wrap" class="">
				<div data-src="{{ asset('assetsfront/images/slide.jpg') }}">
				...
				<div data-src="{{ asset('assetsfront/images/slide1.jpg') }}">
					<div class="caption fadeIn">
						<h2>Maldives</h2>
						<div class="price">
							FROM
				...
				<div data-src="{{ asset('assetsfront/images/slide2.jpg') }}">
					<div class="caption fadeIn">
						<h2>Venice</h2>
						<div class="price">
							FROM
		...
		<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - February 10, 2014!</div>
			<div class="container_12">
				...
				<div class="grid_5 prefix_1">
					<h3>Welcome</h3>
					<img src="{{ asset('assetsfront/images/page1_img1.jpg') }}" alt="" class="img_inner fleft">
					...
					<blockquote class="bq1">
						<img src="{{ asset('assetsfront/images/page1_img2.jpg') }}" alt="" class="img_inner noresize fleft">
						<div class="extra_wrapper">
